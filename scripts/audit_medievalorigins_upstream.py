...
PACK_LANG = ROOT / "src/main/resources/resourcepacks/fallback_localizations/assets/medievalorigins/lang"
...
def main():
    ...
    for locale in LOCALES:
        ...
        # Our fallback should only cover keys that upstream does not already translate.
