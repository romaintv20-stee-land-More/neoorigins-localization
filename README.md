...
|---|---|---:|---:|---|
| Minecraft 1.21.1 | `1.1.0+1.21.1` | 21 | 91 | NeoOrigins + Medieval Origins Revival + ibarn's quartet origins addon + Origins Fantasy + Origins: Backgrounds + Origins: More Backgrounds + Origins: Backgrounds ISS + Origins Furries + Origins: Classes Extended + Origins: Classes ISS + Origin Architect + Pathfinder Origins (Pathfinder : 12 locales) |
| Minecraft 26.1 / 26.1.1 / 26.1.2 | `1.1.0+26.1` | 25 | 91 | NeoOrigins uniquement + delta 26.1 |
| Minecraft 26.2 | `1.1.0+26.2` | 25 | 91 | NeoOrigins uniquement + delta 26.2 |
...
**Pathfinder Origins 0.4.0** est ajouté en 1.1.0 avec **406/406 chaînes** traduites dans 12 locales (`fr_fr`, `de_de`, `es_es`, `pt_br`, `nl_nl`, `it_it`, `pl_pl`, `ru_ru`, `tr_tr`, `zh_cn`, `cs_cz`, `hu_hu`). Les 91 langues existantes de NeoOrigins et des intégrations déjà présentes sont conservées.
...
| Pathfinder Origins | 0.4.0 | 406/406 dans 12 locales | 406/406 |
