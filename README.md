...
|---|---|---:|---:|---|
| Minecraft 1.21.1 | `0.9.0-beta+1.21.1` | 21 | 91 | NeoOrigins + Medieval Origins Revival + ibarn's quartet origins addon + Origins Fantasy + Origins: Backgrounds + Origins: More Backgrounds + Origins: Backgrounds ISS + Origins Furries + Origins: Classes Extended + Origins: Classes ISS + Origin Architect |
| Minecraft 26.1 / 26.1.1 / 26.1.2 | `0.9.0-beta+26.1` | 25 | 91 | NeoOrigins uniquement + delta 26.1 |
| Minecraft 26.2 | `0.9.0-beta+26.2` | 25 | 91 | NeoOrigins uniquement + delta 26.2 |
